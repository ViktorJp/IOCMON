...
version="0.3.8"                 # current script version
...
# -------------------------------------------------------------------------------------------------------------------------
# fspathexcluded is the single shared exclusion rule set (self-paths, quarantine suffix, fswatchexclude, fsexcludeext) for every filesystem-integrity path, used by both the periodic scan and the real-time inotify queue.
